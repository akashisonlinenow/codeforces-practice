...
// Code
void ak()
{ // refer peter griffin utube...
    ll n;
    cin >> n; // idea - obtain max freq of no. at (i,0) ; i->0 to n-1 that no. will come first in o/p and print all the no.s of the row in sequence where the first element is not the max. freq wala element
